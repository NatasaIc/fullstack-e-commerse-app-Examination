const products = [
  {
    ...
    image: 'All-In-OneMiracleSerum.jpg',
    short_description:
  ...
  },
  {
    ...
    long_description:
      'Take a step towards sustainable skincare with our Cotton Face Pads. These reusable pads, made from soft organic cotton, are perfect for removing makeup and applying toner. An eco-friendly addition to your daily routine.',
    price: 14.99,
    category: 'Makeup',
    brand: 'Pardos',
    countInStock: 10,
